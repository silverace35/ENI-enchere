...
public enum ErrorCodes {
	...
	PSEUDO("Caractères alphanumériques requis.", "^.{2,30}$"),
	NOM("Caractères alphanumériques requis.", "^.{2,30}$"),
	PRENOM("Caractères alphanumériques requis.", "^.{2,30}$"),
	EMAIL("Type de format possible xxxx-xxxx@xx-xx.xxx.", "^[\\w-\\.]+@([\\w-]+\\.)+[\\w-]{2,4}$"),
	TEL("+33123123112 ou 0110203040.", "(^\\+{1}+[3]{2}+[0-9]{9}$)|(^0{1}+[0-9]{9}$)"),
	RUE("Caractères alphanumériques requis.", "^.{2,30}$"),
	CODEPOSTAL("Code postal incorrect.", "^[0-9]{5}$"),
	VILLE("Caractères alphanumériques requis.", "^.{2,50}$"),
