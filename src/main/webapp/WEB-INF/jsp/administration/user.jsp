	...
	<table class="table table-striped">
		...
		<tbody>
			...
			<tr>
				...
				<td><a href="suppressionUtilisateur/<%=u.getNoUtilisateur() %>" title="Supression" href=""><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
