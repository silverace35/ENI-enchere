		...
		<form action="<%=request.getContextPath()%>/ENI-enchere" method="GET">
			<div class="search-container">
				<img class="icon" src="img/recherche.png"> <input
					name="barreRecherche" type="search" required />
			</div>
			...
			<div class="radio-container">
				<div class="achats-container">
					<input name="radio" id="radio-achat" type="radio"> <label
						for="radio-achat">Achats</label> <input name="enchere-ouverte"
						id="enchere-ouverte" type="checkbox"> <label
						for="enchere-ouverte">Enchères ouvertes</label> <input
						name="mes-encheres" id="mes-encheres" type="checkbox"> <label
						for="mes-encheres">Mes enchères</label> <input
						name="enchere-remportees" id="enchere-remportees" type="checkbox">
			...
			<button class="form-btn" type="submit">Rechercher une
				enchère</button>
		</form>
		...
		<div class="list-encheres">
			<div class="enchere">
				...
				<div class="details-enchere">
					...
					<p>
						<a href="#"><%=av.getNomPrenomAuteur()%></a>
					</p>
				</div>
			</div>
		</div>
