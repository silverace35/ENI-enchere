...
%>
	<main>
		...
		<%} %>
		<%if (!encheres.isEmpty() && av.getArticleStatus() == ArticleStatus.ET && Integer.valueOf(String.valueOf(session.getAttribute("noUtilisateur"))) == u.getNoUtilisateur()) { %>
		...
		<div class="vente">
			...
			<div class="detail-vente">
				...
				<% if (av.getArticleStatus() == ArticleStatus.EC && av.getNoUtilisateur() !=  Integer.valueOf(String.valueOf(session.getAttribute("noUtilisateur")))){%>
